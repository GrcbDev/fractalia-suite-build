...
@Component({
  ...
  templateUrl: './agent-service.component.html',
  styleUrls: ['./agent-service.component.scss']
})
export class AgentServiceComponent implements OnInit {
  @Input() data: any;
  isloading = true;
  modalRef: any;
  constructor(
  ...
  loadService(){
    this.router.navigate(["service/"+this.data.code+"/agent"]);
  }
