...
@Component({
  ...
  styleUrls: ['./antivirus-service.component.scss']
})
export class AntivirusServiceComponent implements OnInit {
  @Input() data: any;
  isloading = true;
  modalRef: any;
  constructor(
  ...
  loadService() {
    this.router.navigate(["service/"+this.data.code+"/externallicense"]);
  }
}
