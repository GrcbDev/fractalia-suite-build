...
@Component({
  selector: 'app-bitdefender-mobile',
  templateUrl: './bitdefender-mobile.component.html',
  styleUrls: ['./bitdefender-mobile.component.scss']
})
export class BitdefenderMobileComponent implements OnInit {
  @Input() data: any;
  isloading = true;
  modalRef: any;
  constructor(
