...
@Component({
  selector: 'app-bitdefender-security',
  templateUrl: './bitdefender-security.component.html',
  styleUrls: ['./bitdefender-security.component.scss']
})
export class BitdefenderSecurityComponent implements OnInit {
  @Input() data: any;
  isloading = true;
  modalRef: any;
  constructor(
  ...
  loadService(){
    this.router.navigate(["service/"+this.data.code+"/licenseinternet"]);
  }
}
