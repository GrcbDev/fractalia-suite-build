...
@Component({
  selector: 'app-bitdefender-service',
  templateUrl: './bitdefender-service.component.html',
  styleUrls: ['./bitdefender-service.component.scss']
})
export class BitdefenderServiceComponent implements OnInit {
  @Input() data: any;
  isloading = true;
