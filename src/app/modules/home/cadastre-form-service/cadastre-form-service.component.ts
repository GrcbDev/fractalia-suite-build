...
@Component({
  selector: 'app-cadastre-form-service',
  templateUrl: './cadastre-form-service.component.html',
  styleUrls: ['./cadastre-form-service.component.scss']
})
export class CadastreFormServiceComponent implements OnInit {
