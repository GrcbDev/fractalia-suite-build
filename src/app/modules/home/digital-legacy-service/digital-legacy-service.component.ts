...
@Component({
  ...
  templateUrl: './digital-legacy-service.component.html',
  styleUrls: ['./digital-legacy-service.component.scss']
})
export class DigitalLegacyServiceComponent implements OnInit {
  @Input() data: any;
  isloading = true;
  modalRef: any;
  constructor(
