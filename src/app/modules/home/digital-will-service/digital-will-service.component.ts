...
@Component({
  selector: 'app-digital-will-service',
  templateUrl: './digital-will-service.component.html',
  styleUrls: ['./digital-will-service.component.scss']
})
export class DigitalWillServiceComponent implements OnInit {
  @Input() data: any;
  isloading = true;
  modalRef: any;
  constructor(
  ...
  loadService(){
    this.router.navigate(["service/"+this.data.code+"/digital-legacy"]);
  }
