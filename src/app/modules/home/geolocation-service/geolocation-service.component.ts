...
@Component({
  selector: 'app-geolocation-service',
  templateUrl: './geolocation-service.component.html',
  styleUrls: ['./geolocation-service.component.scss']
})
export class GeolocationServiceComponent implements OnInit {
  @Input() data: any;
  constructor(
