...
@Component({
  selector: 'app-rgpd-potential-clients',
  templateUrl: './rgpd-potential-clients.component.html',
  styleUrls: ['./rgpd-potential-clients.component.scss']
})
export class RgpdPotentialClientsComponent implements OnInit {
  @Input() data: any;
  ...
  saveFormData(isEditMode?: boolean) {
    ...
    if(this.questionsForm.valid && this.stepForm.valid) {
      ...
      this.rgpdService.proccessDataToUpdate(RGPDSteps.PotentialClients, { stepForm : this.stepForm, formValues: formValues, agentList: this.agentList });
