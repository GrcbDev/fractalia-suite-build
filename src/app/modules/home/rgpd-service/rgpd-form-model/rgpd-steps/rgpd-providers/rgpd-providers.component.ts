...
@Component({
  selector: 'app-rgpd-providers',
  templateUrl: './rgpd-providers.component.html',
  styleUrls: ['./rgpd-providers.component.scss']
})
export class RgpdProvidersComponent implements OnInit {
  @Input() data: any;
  ...
  saveFormData(isEditMode?: boolean) {
    ...
    if(this.questionsForm.valid && this.stepForm.valid) {
      ...
      this.rgpdService.proccessDataToUpdate(RGPDSteps.Providers, { stepForm : this.stepForm, formValues: formValues, agentList: this.agentList });
