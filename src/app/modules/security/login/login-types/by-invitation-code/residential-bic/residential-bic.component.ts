...
@Component({
  selector: 'app-residential-bic',
  templateUrl: './residential-bic.component.html',
  styleUrls: ['./residential-bic.component.scss']
})
export class ResidentialBicComponent implements OnInit {
  ...
  onSubmit() {
    ...
    if(this.loginForm.valid) {
      this.loginTypeService.initLoginProcess(this.loginForm.getRawValue(), LoginType.LoginByInvitationCode);
    }
  }
