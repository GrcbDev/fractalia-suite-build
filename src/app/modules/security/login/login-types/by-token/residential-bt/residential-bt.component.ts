...
@Component({
  selector: 'app-residential-bt',
  templateUrl: './residential-bt.component.html',
  styleUrls: ['./residential-bt.component.scss']
})
export class ResidentialBtComponent implements OnInit {
  ...
  onSubmit() {
    ...
    if(this.loginForm.valid) {
      this.loginTypeService.initLoginProcess(this.loginForm.getRawValue(), LoginType.LoginByToken);
    }
  }
