...
@Component({
  selector: 'app-residential-eap',
  templateUrl: './residential-eap.component.html',
  styleUrls: ['./residential-eap.component.scss']
})
export class ResidentialEapComponent implements OnInit {
  ...
  ngOnInit() {
    console.log(this.loginTypeService)
