...
@Component({
  selector: 'app-default-free',
  templateUrl: './default-free.component.html',
  styleUrls: ['./default-free.component.scss']
})
export class DefaultFreeComponent implements OnInit {
