...
@Component({
  selector: 'app-residential-lap',
  templateUrl: './residential-lap.component.html',
  styleUrls: ['./residential-lap.component.scss']
})
export class ResidentialLapComponent implements OnInit {
