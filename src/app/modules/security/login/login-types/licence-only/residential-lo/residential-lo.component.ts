...
@Component({
  selector: 'app-residential-lo',
  templateUrl: './residential-lo.component.html',
  styleUrls: ['./residential-lo.component.scss']
})
export class ResidentialLoComponent implements OnInit {
  ...
  onSubmit() {
    ...
    if(this.loginForm.valid) {
      this.loginTypeService.initLoginProcess(this.loginForm.getRawValue(), LoginType.LoginWithLicence);
    }
  }
