...
@Component({
  selector: 'app-default-mapfre',
  templateUrl: './default-mapfre.component.html',
  styleUrls: ['./default-mapfre.component.scss']
})
export class DefaultMapfreComponent implements OnInit {
