...
import { DefaultExpertOrangeComponent } from './default-expert-orange/default-expert-orange.component';
import { ResidentialExpertOrangeComponent } from './residential-expert-orange/residential-expert-orange.component';


@Component({
  selector: 'app-email-and-password',
  templateUrl: './expert-orange.component.html',
  styleUrls: ['./expert-orange.component.scss'],
})
export class ExpertOrangeComponent implements OnInit {
  ...
  renderDefaultLayout() {
    this.dynamicRenderComponentService.loadComponent(this.directiveContainer, DefaultExpertOrangeComponent);
  }

  renderResidentialLayout(){
    this.dynamicRenderComponentService.loadComponent(this.directiveContainer, ResidentialExpertOrangeComponent);
  }
