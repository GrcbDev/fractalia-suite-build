...
@Component({
  selector: 'app-default-ssaobrasil',
  templateUrl: './default-ssobrasil.component.html',
  styleUrls: ['./default-ssobrasil.component.scss']
})
export class DefaultSsoBrasilComponent implements OnInit {
