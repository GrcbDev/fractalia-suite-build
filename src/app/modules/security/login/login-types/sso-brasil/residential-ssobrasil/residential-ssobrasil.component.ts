...
@Component({
  selector: 'app-residential-ssobrasil',
  templateUrl: './residential-ssobrasil.component.html',
  styleUrls: ['./residential-ssobrasil.component.scss']
})
export class ResidentialSsoBrasilComponent implements OnInit {
