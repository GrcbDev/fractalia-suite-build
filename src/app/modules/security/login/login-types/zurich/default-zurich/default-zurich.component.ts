...
@Component({
  selector: 'app-default-zurich',
  templateUrl: './default-zurich.component.html',
  styleUrls: ['./default-zurich.component.scss']
})
export class DefaultZurichComponent implements OnInit {
