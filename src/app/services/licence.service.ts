...
export class LicenceService {
  ...
  public getUserLicence(partnerSuiteId: number, serviceId: number, languageId: number, serviceTypeId: number) {
    ...
    return this.http.get(environment.apiEndpoint + "api/licence", { params });
    // return this.http.get(environment.apiEndpoint + "api/licence", { params, headers }).toPromise().then((result: any) => {
